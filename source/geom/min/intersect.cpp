...
bool min::intersect(const min::sphere<T, vec> &s, const min::ray<T, vec> &ray, vec<T> &p)
{
...
template <typename T, template <typename> class vec>
bool min::intersect(const min::aabbox<T, vec> &box, const min::ray<T, vec> &r, vec<T> &p)
{
...
template <typename T, template <typename> class vec>
bool min::intersect(const min::oobbox<T, vec> &box, const min::ray<T, vec> &r, vec<T> &p)
{
