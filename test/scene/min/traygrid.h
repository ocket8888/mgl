...
bool test_ray_grid()
{
    ...
    // vec2 oobb grid
    {
        ...
        min::grid<double, uint_fast16_t, uint_fast32_t, min::vec2, min::oobbox, min::oobbox> g(world);
    ...
    // vec3 oobb grid
    {
        ...
        min::grid<double, uint_fast16_t, uint_fast32_t, min::vec3, min::oobbox, min::oobbox> g(world);
    ...
    // vec4 oobb grid
    {
        ...
        min::grid<double, uint_fast16_t, uint_fast32_t, min::vec4, min::oobbox, min::oobbox> g(world);
