...
bool test_ray_tree()
{
    ...
    // vec2 sphere tree
    {
        ...
        for (size_t i = 0; i < N; i++)
        {
            ...
            if (!out)
            {
                throw std::runtime_error("Failed sphere tree vec2 ray failed");
            }
        }
    }
    ...
    // vec2 aabb tree
    {
        ...
        for (size_t i = 0; i < N; i++)
        {
            ...
            if (!out)
            {
                throw std::runtime_error("Failed aabbox tree vec2 ray failed");
            }
        }
    }
    ...
    // vec3 sphere tree
    {
        ...
        for (size_t i = 0; i < N; i++)
        {
            ...
            if (!out)
            {
                throw std::runtime_error("Failed sphere tree vec3 ray failed");
            }
        }
    }
    ...
    // vec3 aabb tree
    {
        ...
        for (size_t i = 0; i < N; i++)
        {
            ...
            if (!out)
            {
                throw std::runtime_error("Failed aabbox tree vec3 ray failed");
            }
        }
    }
    ...
    // vec4 sphere tree
    {
        ...
        for (size_t i = 0; i < N; i++)
        {
            ...
            if (!out)
            {
                throw std::runtime_error("Failed sphere tree vec4 ray failed");
            }
        }
    }
