...
LIBS = source/file/libmgl.file.a source/geom/libmgl.geom.a source/math/libmgl.math.a source/platform/libmgl.platform.a
...
ALL_OBJECTS = $(FILE_SOURCES) $(GEOM_SOURCES) $(MATH_SOURCES) $(PLAT_SOURCES)
